...
import pe.edu.tecsup.MainActivity;
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Log.d(TAG, "iniciar sesión con correo electrónico y contraseña: inCompleta:" + task.isSuccessful());
                        if (!task.isSuccessful()) {
                            loginPanel.setVisibility(View.VISIBLE);
                            progressBar.setVisibility(View.GONE);
                            Log.e(TAG, "iniciar sesión con correo electrónico y contraseña: falló", task.getException());
